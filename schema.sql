...
CREATE TABLE Applications (
    ...
    verifyPDP BIT NOT NULL,
    verifyCertificate BIT NOT NULL,
    ...
    verifyInvoluntarilyToCurLoc BIT DEFAULT 0,
    verifyToHeadCoach BIT DEFAULT 0,
    verifyToSpecialEd BIT DEFAULT 0,
    ...
    speaksFrench BIT DEFAULT 0,
    speaksKorean BIT DEFAULT 0,
    speaksSpanish BIT DEFAULT 0,
    speaksOther BIT DEFAULT 0,
